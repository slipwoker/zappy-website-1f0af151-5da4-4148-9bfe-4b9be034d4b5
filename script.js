...
if (!window.zappyContactFormLoaded) {
  ...
  try {
    ...
    const zappyResponse = await fetch('https://api.zappy5.com/api/email/contact-form', {
      ...
      body: JSON.stringify({
        websiteId: '1f0af151-5da4-4148-9bfe-4b9be034d4b5',
...
alert('תודה על פנייתך! ניצור איתך קשר בהקדם.');this.reset();});}});
